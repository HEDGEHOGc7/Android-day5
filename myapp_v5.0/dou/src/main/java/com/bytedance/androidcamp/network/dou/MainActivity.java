...
public class MainActivity extends AppCompatActivity {
    ...
    private Retrofit retrofit = new Retrofit.Builder().baseUrl(IMiniDouyinService.mURL)
    ...
    private void postVideo() {
        ...
        Call<PostVideo> call = miniDouyinService.postVideo("5757", "james", coverImagePart, videoPart);
        call.enqueue(new Callback<PostVideo>() {
            @Override
            public void onResponse(Call<PostVideo> call, Response<PostVideo> response) {
                if (response.isSuccessful()&&response.body()!=null ) {
                    mBtn.setEnabled(true);
                    mBtn.setText("select a photo");
                    Toast.makeText(MainActivity.this, "Upload succeeded", Toast.LENGTH_LONG).show();
                } else {
                    mBtn.setEnabled(true);
    ...
    public void fetchFeed(View view) {
        ...
        // TODO 10: get videos & update recycler lis
        miniDouyinService.getVideos().enqueue(new Callback<GetVideo>(){
